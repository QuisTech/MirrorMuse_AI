        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="rounded-3xl bg-[#0a0d14] border border-white/[0.08] p-5 space-y-4">
            <div className="flex items-center justify-between border-b border-white/[0.08] pb-3">
              ...
              <button onClick={() => onAddToCart && onAddToCart({ title: "Complete AI Treatment Regimen Set", price: "$156.00", category: "AI Treatment Set" })} className="px-3.5 py-1.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-black font-bold text-xs flex items-center gap-1.5 cursor-pointer shadow-lg">
              ...
              {analysisData.recommendedSkincare.map((p, idx) => (
                <div key={idx} className="p-4 rounded-2xl bg-[#0d1017] border border-white/[0.06] flex items-center justify-between gap-4 hover:border-indigo-500/40 transition-all">
                  ...
                  <div className="text-right shrink-0">
                    ...
                    <button onClick={() => onAddToCart && onAddToCart({ title: p.title, price: p.price, category: "Skin Regimen" })} className="text-[10px] text-indigo-400 hover:text-indigo-300 font-bold flex items-center gap-1 mt-1 cursor-pointer">
